model System_LMO
  ...
  parameter Modelica.Units.SI.Time Edep_starttime = 1.00e-5 "Start time of energy deposition";  
  //  - Electrical, bias
  parameter Modelica.Units.SI.Current Bias_I = 1000.1e-6 "Bias current";
  ...
  parameter Real K4 = 8.80e-6 "Goldpad2 -> TES Electron System";
  parameter Real K5 = 7.99e-5 "Goldpad2 -> Si chip";
  parameter Real K6 = 1.08e-6 "Si chip -> TES, electron-phonon coupling";
  parameter Real K7 = 8.80e-6 "TES -> GoldPadTES";
  parameter Real K8 = 6.83e-8 "GoldpadTES -> Meander";
  ...
  parameter Real K14 = 7.84e-5 "Absorber -> bath";
...
equation
  ...
  annotation(
    ...
    Icon,
    version = "",
  experiment(StartTime = 0, StopTime = 20e-3, Tolerance = 1e-06, Interval = 1e-06),
